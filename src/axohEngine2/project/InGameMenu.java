...
public class InGameMenu {
	...
	public void render(JFrame frame, Graphics2D g2d, int inX, int inY) {
		...
		if(_option == OPTION.MAGIC){
			g2d.setColor(Color.BLACK);
			g2d.drawString("Help", 880, 200);
			g2d.drawString("Use WASD to move", 600,400);
			
		//	g2d.drawString("Set a key for inventory", 600, 375);
		//	g2d.drawString("Set a key for opening", 600, 475);
	 }
		...
		if(_option == OPTION.CONTROLS){
			g2d.setColor(Color.BLACK);
			g2d.drawString("Select key for inventory", 880, 200);
			g2d.drawString("Select key for opening command", 880, 400);
		}
