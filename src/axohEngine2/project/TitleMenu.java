...
public class TitleMenu {
	...
	public void render(JFrame frame, Graphics2D g2d, int titleX, int titleY, int titleX2, int titleY2) {
		...
		g2d.setFont(_bold);
		g2d.drawString("New Quest", 660, 700);
		g2d.drawString("Load Quest", 560, 800);
		g2d.setColor(Color.BLUE);
		g2d.setFont(_bigBold);
		//drawString(g2d, "The Ignorance", 555, 100);
		//drawString(g2d, "CHERRY", 300, 55);
